...
public interface ItemService {
     ...
     * @return 对应商品列表
     */
    PagedGridResult<SearchItemsVO> searchItemsByKeywords(String keywords, String sort,
                                                         Integer page, Integer pageSize);
     ...
     * @return 对应商品列表
     */
    PagedGridResult<SearchItemsVO> searchItemsByCatId(Integer catId, String sort,
                                      Integer page, Integer pageSize);
